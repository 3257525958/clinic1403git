...
CSRF_TRUSTED_ORIGINS = ["https://drmahdiasadpour.ir",'http://drmahdiasadpour.ir','drmahdiasadpour.ir','www.drmahdiasadpour.ir']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'data1403wdf_db',
        'USER': 'root',
        'PASSWORD': 'cCiIqLg9mntM1aIGRx5z',
        'HOST': 'data1403-2-qdy-service',
